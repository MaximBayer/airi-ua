...
<template>
  ...
  >
    <Callout :label="t('settings.modelSupport.label')">
      <p>
        {{ t('settings.modelSupport.description1') }}
      </p>
      <p>
        {{ t('settings.modelSupport.description2') }}
      </p>
    </Callout>
    <ModelManagerDialog v-model="selectedModel">
      <Button variant="secondary">
        {{ t('settings.modelSupport.selectModel') }}
      </Button>
    </ModelManagerDialog>
